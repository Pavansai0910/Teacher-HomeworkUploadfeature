  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Filter Tabs */}
        <View className="bg-[#fed570] flex-1 mx-6 rounded-[20px] mb-6">
          <View className="px-4 p-3">
            <Text grtfonSize={16}
              style={{ fontSize: GetFontSize(16) }}
              className="mb-4 text-[#8E6501] font-inter400"
            >
              Select a topic you want to assign a test.
            </Text>
            <ScrollView
              horizontal
          ...
          {/* Topics List */}
          <ScrollView className="flex-1 px-3 pb-6 mt-4">
            {loading ? (
              <View className="py-8">
