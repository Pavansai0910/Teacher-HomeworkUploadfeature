    ...
    <View>
      ...
      <View className="px-6 mt-2">
        <View className="flex-row gap-2">
          ...
          <TouchableOpacity  onPress={() => navigation.navigate('LessonPlanTopics', { chapterId: selectedChapterId })}className ="flex-row gap-1 flex-1 py-3 bg-[#FED570] rounded-lg justify-center items-center border-2 border-[#FEC107]">
